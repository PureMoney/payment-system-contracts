...
module.exports = function(deployer, network, accounts) {
  ...
  // })
  // .then((token) => {
  //   return deployer.deploy( LocalToken, ether(10000000), 0, "RST000005", "Local Token for Davao City Philippines (by RockStable Inc)", "", 0, rock, uToken.address );
  // })
  // .then((token) => {
  ...
  // })
  // .then((token) => {
  //   return deployer.deploy( LocalToken, ether(10000000), 0, "RST000009", "Local Token for Uzbekistan (by RockStable Inc)", "Uzbekistan", 0, rock, uToken.address );
  // })
  // .then((token) => {
